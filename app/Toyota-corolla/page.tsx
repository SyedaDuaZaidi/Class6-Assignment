...
export default function Corolla(){
    return(<div>
        <div className="flex flex-col text-4xl items-center text-black mt-4 font-bold font-mono">
            <h1>Toyota Corolla 2024 Price In Pakistan</h1>
            <h1>Images , Reviews & Specs</h1>
           <Link href="/img"><img src="1709114684718_Corolla1111.jpg" width="300" className="mt-4 hover:scale-110" alt="Image"></img></Link>
      ...
      <div className="flex flex-wrap w-full px-64 mt-4">
        ...
        <h1 className="text-xl font-medium ml-16">Engine</h1><h1 className="ml-2 text-xl">1800 Cc</h1>
        <h1 className="text-xl font-medium ml-16">Condition</h1><h1 className="ml-2 text-xl">8.5/10</h1>
        <h1 className="text-xl font-medium ml-16">Driven</h1><h1 className="ml-2 text-xl">9,500 KM</h1>
      ...
      <div className=" flex justify-center text-2xl text-green-600 font-medium mt-7">
        <h1>PKR 50,000,000</h1></div>
      <div className="flex justify-center w-full mt-5 mb-8" ><button className=" w-72 h-12 bg-blue-800 text-white text-3xl text-center border-blue-950 border rounded-xl hover:bg-blue-500"><Link href="/Make-Payment">Make-Payment</Link></button></div>
     </div>
    );
}