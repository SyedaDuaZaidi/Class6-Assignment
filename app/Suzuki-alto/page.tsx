...
export default function Alto(){
    return(<div>
        <div className="flex flex-col text-4xl items-center text-black mt-4 font-bold font-mono">
            <h1>Suzuki Alto 2024 Price In Pakistan</h1>
            <h1>Images , Reviews & Specs</h1>
            <Link href="/img"><img src="Suzuki-Alto-VXR-Price-in-Pakistan-jpg.webp" width="300" className="mt-4 hover:scale-110" alt="Image"></img></Link>
      ...
      <div className="flex flex-wrap w-full px-64 mt-4">
        ...
        <h1 className="text-xl font-medium ml-16">Engine</h1><h1 className="ml-2 text-xl">658 cc</h1>
        <h1 className="text-xl font-medium ml-16">Condition</h1><h1 className="ml-2 text-xl">8.5/10</h1>
        <h1 className="text-xl font-medium ml-16">Driven</h1><h1 className="ml-2 text-xl">140 KM/H</h1>
        <h1 className=" text-xl font-medium mt-3 ml-20">Suspension Type</h1><h1 className="ml-2 mt-3 text-xl">Soft Suspension</h1>
        <h1 className=" text-xl font-medium mt-3 ml-16">Transmission</h1><h1 className="ml-2 mt-3 
        text-xl">Automatic & Manual</h1>
        <h1 className=" text-xl font-medium mt-3 ml-56">Avg</h1><h1 className="ml-2 mt-3 text-xl">18 Km Per ltr</h1>
      ...
      <div className=" flex justify-center text-2xl text-green-600 font-medium mt-7">
        <h1>PKR 2,331,000</h1></div>
      <div className="flex justify-center w-full mt-5 mb-8" >
        <button className=" w-60 h-12 bg-blue-800 text-white text-3xl text-center border-blue-950 border rounded-xl hover:bg-blue-500"><Link href="/Make-Payment">Make-Payment</Link></button></div>
   </div>
    );
}